...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:  # defines what is passed to the serializer
        ...
        # what is passed to the user, don't include admin info
    ...
    def update(self, instance, validated_data):  # override update method
        ...
        password = validated_data.pop('password', None)  # get password from data, remove from dict. optional field
...
class AuthTokenSerializer(serializers.Serializer):
    ...
    password = serializers.CharField(
        ...
        trim_whitespace=False,  # ensure doesn't trim, incase it's deliberate
    )
    ...
    def validate(self, attrs):  # attrs: attributes
        ...
        if not user:
            ...
            raise serializers.ValidationError(msg, code='authorization')  # returns bad request
